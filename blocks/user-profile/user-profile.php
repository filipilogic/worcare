...
<?php get_template_part('components/intro'); ?>
	...
	<div class="ud-width-1_4 ud-dl-badges <?php if ( ! $badge_value_total ) { echo 'ud-blurred'; } ?>">
		...
		<?php if ( $badge_value_total > 0 && $badge_value_total < 25 ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/Supportive.zip" target="_self">להורדת קבצים - תג ארגוני <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>
		<?php if ( $badge_value_total >= 25 && $badge_value_total < 500  ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/Empowering.zip" target="_self">להורדת קבצים - תג ארגוני <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>
		<?php if ( $badge_value_total >= 500  ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/Ambassador.zip" target="_self">להורדת קבצים - תג ארגוני <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>
	</div>

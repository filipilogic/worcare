...
<?php get_template_part('components/intro'); ?>
	...
	<div class="ud-width-3_4 ud-main-info">
		...
		<div class="ud-main-info-col-2">
			...
			<?php if ( ! $badge_value_total ) { ?><p class="ud-main-info-last-p">אנו שמחים על הצטרפותך!  על מנת להיות חלק ממעגל מעסיקי Worcare ולייצר את האמנה הארגונית שלך, יש למלא את השאלון המצורף. בהצלחה!</p><?php } ?>
			<?php if ( $badge_value_total ) { ?><p class="ud-main-info-last-p">באיזור המעסיק תוכל לערוך את האמנה האירגונית, להוריד  את תו התקן של ארגונך ולמפות את בני המשפחה המטפלים בארגון.</p><?php } ?>
	...
	<div class="ud-width-1_4 ud-dl-badges <?php if ( ! $badge_value_total ) { echo 'ud-blurred'; } ?>">
		...
		<?php if ( $badge_value_total > 0 && $badge_value_total < 25 ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/Supportive.zip" target="_self">להורדת קבצים - תו תקן <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>
		<?php if ( $badge_value_total >= 25 && $badge_value_total < 500  ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/Empowering.zip" target="_self">להורדת קבצים - תו תקן <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>
		<?php if ( $badge_value_total >= 500  ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/Ambassador.zip" target="_self">להורדת קבצים - תו תקן <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>
	</div>
	...
	<div class="ud-width-2_4 ud-corp-charter <?php if ( ! $badge_value_total ) { echo 'ud-blurred'; } ?>">
		...
		<div class="ud-corp-charter-buttons">
			...
			<?php if ( $badge_value_total ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/WorCare_Kit.rar" target="_blank">קיט פרסומי <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>

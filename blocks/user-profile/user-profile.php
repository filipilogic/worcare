...
<?php get_template_part('components/intro'); ?>
	...
	<div class="ud-width-3_4 ud-main-info">
		...
		<div class="ud-main-info-col-2">
			...
			<p class="ud-main-info-last-p">אנו שמחים על הצטרפותך!  על מנת להיות חלק ממעגל מעסיקי Worcare ולייצר את האמנה הארגונית שלך, יש למלא את השאלון המצורף. בהצלחה!</p>
	...
	<div class="ud-width-2_4 ud-corp-charter <?php if ( ! $badge_value_total ) { echo 'ud-blurred'; } ?>">
		...
		<p>כמה מילים על האמנה הארגונית ואז- כאן תוכלו להוריד את קובץ האמנה, לשדרג ולערוך  אותה בכל שלב.</p>
		<div class="ud-corp-charter-buttons">
			...
			<?php if ( $badge_value_total ) { ?><a class="il_btn" href="/wp-content/uploads/2024/03/WorCare-Kit.rar" target="_blank">קיט פרסומי <img src="/wp-content/uploads/2024/01/dl-button-icon.png"></a><?php } ?>

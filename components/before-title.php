...
$before_title_font_size = get_field('before_title_font_size');
$before_title_font_weight = get_field('before_title_font_weight');
$before_title_color = get_field('before_title_color');
$before_title_custom_color = get_field('before_title_custom_color');
$before_title_font_size_ld = get_field('before_title_font_size_ld');
$before_title_font_size_mt = get_field('before_title_font_size_mt');
$before_title_margin_bottom_ld = get_field('before_title_margin_bottom_ld');
$before_title_margin_bottom_mt = get_field('before_title_margin_bottom_mt');
